...
<div class="tip custom-block" style={{padding: '12px',border: 'none', color: '#bcc0ff', backgroundColor:'rgba(100, 108, 255, .08)', borderRadius: '12px', marginBottom: '16px', height: '50px'}}>

Want to try out the application? Skip to [Getting Started](/docs/guides/getting-started).
